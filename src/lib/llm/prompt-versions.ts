...
export const PROMPT_VERSIONS = {
  ...
  "hypothesis-gen": "v4.1-2026-05-19",   // D-055 footnote: topic-match-not-support anti-example + runtime rectifier
  "persona-gen": "v4.1-2026-05-19",      // D-055 footnote: topic-match-not-support anti-example + runtime rectifier
  "question-gen": "v4-2026-05-14",       // D-040: one variant marked is_recommended per question (fatigue-default)
  "analysis-gen": "v3-2026-05-18",       // D-055: verdict provenance tiers (data-grounded / data-extrapolated / general-knowledge)
  ...
  "provenance-audit": "v1-2026-05-19",   // D-055 footnote: runtime topic-match-vs-support audit
  "embed-doc": "voyage-3",
