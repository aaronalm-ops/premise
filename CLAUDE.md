...
- **Next**: (a) dogfood Premise on a real client research project — highest portfolio leverage; (b) stop building, write the story (LinkedIn post, portfolio page, cold-email copy); (c) deferred items still standing: D-7 streaming, R-5 skip logic, E-5 model-regression — original rationale holds.
